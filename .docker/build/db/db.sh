...
then
        ...
        while true; do
            ...
            case ${yn} in
                [Yy]* )
                    ...
                    replaceFileRow src/.env "MYSQL_DATABASE" "MYSQL_DATABASE='${newDatabase,,}'";
    ...
    then
        ...
        replaceFileRow src/.env "POSTGRES_HOST" "POSTGRES_HOST='$PROJECT_NAME-postgresql'";
        ...
        while true; do
            ...
            case ${yn} in
                [Yy]* )
                    read -rp "Enter database name: " newDatabase;
                    replaceFileRow src/.env "POSTGRES_DATABASE" "POSTGRES_DATABASE='${newDatabase,,}'";
